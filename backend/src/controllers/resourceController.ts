...
import {
    getResources,
    createResource as createResourceSuccess,
    updateResource as updateResourceSuccess,
    deleteResource as deleteResourceSuccess
} from "../handlerResponse/succesHandler/configs.ts"
...
export const getAllResources = async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    try {
        ...
        succesHandler(res, getResources, { ressource: resources })
        return
    } catch (error) {
...
export const getAllPublishedResources = async (req: Request, res: Response): Promise<void> => {
    try {
        const resources = await Resource.find({ status: "PUBLISHED" }).lean()
        succesHandler(res, getResources, { ressource: resources })
        return
    } catch (error) {
        const errorMessage = error instanceof Error ? error.message : unexpectedError
...
export const getResourceById = async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    try {
        ...
        if (resource.status === "PUBLISHED") {
            succesHandler(res, getResources, { ressource: resource })
            return
        }
        ...
        if (
            !user ||
            !user.role ||
            (user.role !== "administrateur" && user.role !== "super-administrateur" && user._id.toString() !== resource.authorId.toString())
        ) {
            errorHandler(res, unauthorized)
            return
        }
...
export const createResource = async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        console.log(
            "🔍 DEBUG - createResource called with file:",
            req.file
                ? {
        ...
        succesHandler(res, createResourceSuccess, { ressource: resource })
        return
    } catch (error) {
...
export const updateResource = async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        succesHandler(res, updateResourceSuccess, { ressource: newResource })
        return
    } catch (error) {
        const errorMessage = error instanceof Error ? error.message : unexpectedError
        errorHandler(res, errorMessage)
...
export const updateResourceStatus = async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        // Prepare update data
        const updateData: Partial<ResourceInterface> & { status: string; validatedBy?: string; validatedAndPublishedAt?: Date } = { status }
        ...
        if (status === "PUBLISHED") {
            ...
            updateData.validatedBy = undefined
            updateData.validatedAndPublishedAt = undefined
        }
        ...
        succesHandler(res, updateResourceSuccess, { ressource: resource.toObject() as ResourceInterface })
        return
    } catch (error) {
        const errorMessage = error instanceof Error ? error.message : unexpectedError
        errorHandler(res, errorMessage)
...
export const uploadImage = async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    try {
        ...
        succesHandler(res, "Image téléversée avec succès", { imageUrl, imageUuid: imageGridfsUuid })
        return
    } catch (error) {
        const errorMessage = error instanceof Error ? error.message : unexpectedError
        errorHandler(res, errorMessage)
...
export const createTextResource = async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    try {
        ...
        await resource.save()
        succesHandler(res, createResourceSuccess, { ressource: resource.toObject() as ResourceInterface })
        return
    } catch (error) {
        const errorMessage = error instanceof Error ? error.message : unexpectedError
        errorHandler(res, errorMessage)
